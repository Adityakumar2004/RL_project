...
from custom_scripts.factory.factory_env_cfg_fate import OBS_DIM_CFG, STATE_DIM_CFG, FactoryEnvCfg
from custom_scripts.factory.factory_env_cfg_fate import FactoryTaskPegInsertCfg
...
class FactoryEnv(DirectRLEnv):
    ...
    def _set_body_inertias(self):
        ...
        print("old inertias: of size \n", inertias[0].shape, "\n", inertias[0])
        print("new inertias: of size \n", new_inertias[0].shape, "\n", new_inertias[0])
    ...
    def _apply_action(self):
        ...
        ## TODO changes made here
        ## Always compute intermediate values
        ...
        ## TODO changes made here to pass no action and just spawn the asset
        # self.generate_ctrl_signals()
    ...
    def _set_franka_to_default_pose(self, joints, env_ids):
        ...
        ## TODO changes made here i commented this
        ## consequently the joints are moving though there is no shaky movment yet noticed 
        ...
        self._compute_intermediate_values(dt=self.physics_dt)
        print("ef pos after reset", self.fingertip_midpoint_pos[0])
        print("ef lin vel after reset", self.fingertip_midpoint_linvel[0])
        
        self.step_sim_no_action()

        self._compute_intermediate_values(dt=self.physics_dt)
        print("ef pos after no action step ", self.fingertip_midpoint_pos[0])
        print("ef lin vel after no action step ", self.fingertip_midpoint_linvel[0])
