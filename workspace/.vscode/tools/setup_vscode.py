...
# current_path = print(os.path)
workspace_path = '/workspace'
ISAACLAB_DIR = os.environ["ISAACLAB_PATH"]
print(ISAACLAB_DIR)
rel_path_workspace_isaaclab = os.path.relpath(ISAACLAB_DIR, workspace_path)
...
def overwrite_python_analysis_extra_paths(isaaclab_settings: str) -> str:
    ...
    if os.path.exists(isaacsim_vscode_filename):
        ...
        rel_path = os.path.relpath(ISAACSIM_DIR, workspace_path)
    ...
    path_names.extend(['"${workspaceFolder}/' + rel_path_workspace_isaaclab + '/source/' + ext + '"' for ext in isaaclab_extensions])
...
def main():
    ...
    isaaclab_vscode_filename = os.path.join('/workspace', ".vscode", "settings.json")
    ...
    isaaclab_vscode_launch_filename = os.path.join('/workspace', ".vscode", "launch.json")
...
if __name__ == "__main__":
    # main()
    # print(os.path.relpath(ISAACSIM_DIR, workspace_path))
    # print(rel_path_workspace_isaaclab)
    # print(os.path.join('/workspace', ".vscode", "settings.json"))
    main()
    pass
